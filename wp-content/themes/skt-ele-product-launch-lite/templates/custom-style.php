<?php 
/**
 * The Custom Style for SKT Ele Product Launch Lite
 *
...
/*-----------------------------COLORS------------------------------------*/
		...
		.slider-main .nivo-caption .slidebtn a{ 
			...
			background: linear-gradient(to right, <?php echo $complete['sldbtn_color_id']; ?>, <?php echo $complete['sldbtn_gdcolor_id']; ?>);
		}	
		.slider-main .nivo-caption .slidebtn a:hover{background:<?php echo $complete['sldbtn_hvcolor_id']; ?>; color:<?php echo $complete['sldbtn_hvtextcolor_id']; ?>;}
		
		
		.slider-main .nivo-caption .slidebtn2 a{color: <?php echo $complete['sldbtntext_color_id2']; ?>; background: <?php echo $complete['sldbtn_color_id2']; ?>;}	
		.slider-main .nivo-caption .slidebtn2 a:hover{background:<?php echo $complete['sldbtn_hvcolor_id2']; ?>; color:<?php echo $complete['sldbtn_hvtextcolor_id2']; ?>;}
		...
		.arrow-pattern svg g {fill:<?php echo $complete['slide_arrow_pattern_color_id']; ?> !important;}			
		...
		.ourtour .bxslider h3 a {color: <?php echo $complete['reproj_title_color_id']; ?>;}
		.ourtour .bxslider p {color: <?php echo $complete['reproj_comp_color_id']; ?>;}		
		.ourtour .bxslider li .button {color: <?php echo $complete['reproj_btntext_color_id']; ?>; background-color: <?php echo $complete['reproj_btnbg_color_id']; ?>;}
		.ourtour .bxslider li:hover .button {color: <?php echo $complete['reproj_btnhtext_color_id']; ?>; background-color: <?php echo $complete['reproj_btnhbg_color_id']; ?> !important;}		
		.ourtour .ourtour-image {background-color: <?php echo $complete['reproj_imgbg_color_id']; ?>;}		
		.bx-wrapper .bx-controls-direction a {background: <?php echo $complete['reproj_navbg_color_id']; ?>; color: <?php echo $complete['reproj_nav_color_id']; ?>;}		
		.bx-wrapper .bx-controls-direction a:hover {background: <?php echo $complete['reproj_navhbg_color_id']; ?>; color: <?php echo $complete['reproj_navh_color_id']; ?>;}
...
#topmenu ul li.current-menu-item > a:link:after, #topmenu ul li.current-menu-item > a:visited:after, #topmenu ul li.current-menu-parent > a:link:after, #topmenu ul li.current_page_parent > a:visited:after, #topmenu ul li.current-menu-ancestor > a:link:after, #topmenu ul li.current-menu-ancestor > a:visited:after{content:''; border-bottom-color:<?php echo $complete['menutxt_color_active']; ?> !important;}		
		...
		#topmenu ul.sub-menu li a:hover, #topmenu ul.children li a:hover, #topmenu li.menu_highlight_slim:hover, #topmenu ul.sub-menu li.current_page_item a, #topmenu ul.children li.current_page_item a, #topmenu ul.sub-menu li.current-menu-item a, #topmenu ul.children li.current-menu-item a{background-color:<?php echo $complete['mnshvr_color_id']; ?> !important;}	
		 ...
		 #topmenu li.donate-button a {color:<?php echo $complete['donatbtn_color_id'] ?> !important; background-color: <?php echo $complete['donatbtn_bgcolor_id'] ?>;}
		 #topmenu li.donate-button a:hover {color:<?php echo $complete['donatbtn_hcolor_id'] ?> !important; background-color: <?php echo $complete['donatbtn_hbgcolor_id'] ?>;}
...
<?php if(is_front_page()){ ?>
.footer-pattern svg g {fill:<?php echo $complete['footer_pattern_color_id']; ?> !important;}
<?php } ?>
